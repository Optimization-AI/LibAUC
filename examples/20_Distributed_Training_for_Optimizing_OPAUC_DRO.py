...
loss_fn = pAUC_DRO_Loss(data_len=len(trainSet), margin=margin, gamma=gamma, device=device)
optimizer = SOPAs(model.parameters(), lr=lr, mode='adam', weight_decay=weight_decay, device=device)
